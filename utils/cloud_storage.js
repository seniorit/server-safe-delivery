...
const storage = new Storage({
  projectId: "safe-delivery-001",
  keyFilename: './serviceAccountKey.json'
});

const bucket = storage.bucket("gs://safe-delivery-001.appspot.com/");

/**
 * Subir el archivo a Firebase Storage
 * @param {File} file 
 * objeto que sera almacenado en Firebase Storage
 */
